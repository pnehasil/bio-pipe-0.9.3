...
# cze_chr <- read_xlsx("cze_2.1.xlsx", sheet=1) |>
#   select(chromozom, gen) |> 
#   distinct()

var <- read_xlsx("/mnt/raid/Shared/bed_dir_1.2/transkripcni_varianty2.xlsx", sheet=1)  |> 
...
modraky <- function(var, depth){
  ...
  # cds_max <- depth_fil |> dplyr::select(cds_coord_start) |>
  #   as.vector() |> min(cds_coord_start)
  # 
  # print(cds_max)
  # 
  # cds_min <- depth_fil |> dplyr::select(cds_coord_end) |> 
  #   as.vector() |> max(cds_coord_end)
  # 
  # print(cds_min)
