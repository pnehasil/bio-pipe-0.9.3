...
[ -e ${GVCF4_DIR}/dohromady.g.db ] || error_exit "${GVCF4_DIR}/dohromady.g.db not ifound"

FLOG=${WOR_LOGDIR}/${phase}_116_$(date +%y%m%d-%H%M%S).log

ofile=${GVCF4_DIR}/nase.txt
obezfile=${GVCF4_DIR}/nase_bez_show.txt
webfile=${GVCF4_DIR}/unkn_col.web
