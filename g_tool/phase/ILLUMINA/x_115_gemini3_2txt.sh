...
dbfile=${GVCF3_DIR}/dohromady.g.db

[ -e ${GVCF3_DIR}/dohromady.g.db ] || error_exit "${GVCF3_DIR}/dohromady.g.db not ifound"

FLOG=${WOR_LOGDIR}/${phase}_115_$(date +%y%m%d-%H%M%S).log

ofile=${GVCF3_DIR}/nase.txt
obezfile=${GVCF3_DIR}/nase_bez_show.txt
webfile=${GVCF3_DIR}/unkn_col.web
